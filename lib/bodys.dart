                  ...
                  headerBuilder: (BuildContext context, bool isExpanded) {
                    return ListTile(
                      ...
                      title: FittedBox(
                        ...
                        child: Text('我创建的歌单', style: TextStyle(fontSize: 20.0)),
                      ),
                      onTap: () {
                        setState(() {
                          _isExpandedMy = !_isExpandedMy;
                  ...
                  headerBuilder: (BuildContext context, bool isExpanded) {
                    return ListTile(
                      ...
                      title: FittedBox(
                        alignment: Alignment.centerLeft,
                        fit: BoxFit.scaleDown,
                        child: Text('我收藏的歌单', style: TextStyle(fontSize: 20.0)),
                      ),
                      onTap: () {
                        setState(() {
                          _isExpandedFav = !_isExpandedFav;
                          ...
                          children: _playlists_fav.map((playlist) {
                            return ListTile(
                              ...
                              onTap: () async {
                                var ret = await Get.toNamed(
                                  playlist.info.id,
                                  arguments: {'listId': playlist.info.id},
                                  id: 1,
                                );
                              },
                            );
                  ...
                  headerBuilder: (BuildContext context, bool isExpanded) {
                    return ListTile(
                      ...
                      title: FittedBox(
                        fit: BoxFit.scaleDown,
                        alignment: Alignment.centerLeft,
                        child: Text('我的QQ歌单', style: TextStyle(fontSize: 20.0)),
                      ),
                      onTap: () {
                        setState(() {
                          _isExpandedQq = !_isExpandedQq;
