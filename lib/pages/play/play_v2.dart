...
Widget get playV2 => LayoutBuilder(
  builder: (context, boxConstraints) {
                      ...
                      builder: (context) {
                        ...
                        expandAnimationStage2.addListener(() {
                          if (expandAnimationStage2.value >= 0.5) {
                            ...
                            if (_playController.showPlayVInlineLyricOp.value) {
                            ...
                            return LayoutBuilder(
                              builder: (context, constraints) {
                                ...
                                final controlOpacity =
                                    (1.0 - opacityProgress * 3).clamp(0.0, 1.0);
                                    ...
                                    AnimatedBuilder(
                                      ...
                                      builder: (context, child) {
                                        final stage2Progress =
                                            expandAnimationStage2.value.clamp(
                                              0.0,
                                              1.0,
                                            );
                                        ...
                                        child: Row(
                                          ...
                                          children: Get.find<SettingsController>()
                                              ...
                                              .map((tindex) {
                                                Widget btn;
                                                PlayVBtns setBtn =
                                                    PlayVBtns.values[tindex];
                                                if (setBtn ==
                                                    PlayVBtns.volumeSlider) {
                                                  ...
                                                  btn = playModeButton;
                                                    ...
                                                    PlayVBtns.previous) {
                                                  btn = buildPreviousButton();
                                                } else if (setBtn ==
                                                    PlayVBtns.playPause) {
                                                  btn = buildPlayPauseButton(
                                                    expandProgress,
                                                  );
                                                } else if (setBtn ==
                                                    PlayVBtns.next) {
                                ...
                                ).sbwh(availableWidth, totalHeight);
                              },
                            );
                          },
                        );
    ...
    ).sbh(_playController.playVMaxHeight);
  },
);
