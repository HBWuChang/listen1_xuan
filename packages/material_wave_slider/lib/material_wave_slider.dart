...
class MaterialWaveSliderState extends State<MaterialWaveSlider> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(covariant MaterialWaveSlider oldWidget) {
    ...
    // 当高度或振幅变化时，清除缓存的路径和绘制对象
    if (oldWidget.height != widget.height || oldWidget.amplitude != widget.amplitude) {
      defaultPath = null;
      defaultPaint = null;
    }
  }
            ...
            child: SizedBox(
              ...
              child: Stack(
                ...
                children: [
                  Positioned.fill(
                    child: ClipRect(
                      ...
                      child: ListView.builder(
                        key: ValueKey(widget.height), // 添加 key 以在高度变化时重建
                        ...
                        itemBuilder: (context, _) => TweenAnimationBuilder<double>(
                          ...
                          builder: (context, value, _) {
                            if (value == _amplitude && defaultPaint != null) {
                              return defaultPaint!;
                            }
                            return CustomPaint(
                              key: ValueKey(value),
                  ...
                  // 未播放部分的可点击区域（透明背景）
                  Positioned(
                    left: constraints.maxWidth * _percent,
                    right: 0.0,
                    top: 0.0,
                    bottom: 0.0,
                    child: Container(
                  ...
                  Positioned(
                    ...
                    right: 0.0,
                    top: (widget.height - sliderTheme.trackHeight!) / 2.0,
                    child: Container(
