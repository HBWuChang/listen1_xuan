...
fvm flutter build apk --release --target-platform=android-arm64 --analyze-size
fvm flutter build apk --release --target-platform=android-arm64 --split-debug-info=./sdi